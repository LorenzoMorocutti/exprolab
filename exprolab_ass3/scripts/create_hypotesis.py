...
from exprolab_ass3.srv import hint, hintResponse
from exprolab_ass3.srv import correct_hyp,correct_hypResponse
...
#   (in my case: /root/ros_ws/src).
    ...
    try:
        ...
        req.args= ['/root/ros_ws/src/exprolab_ass3/cluedo_ontology.owl', 'http://www.emarolab.it/cluedo-ontology', 'true', 'PELLET', 'true']
